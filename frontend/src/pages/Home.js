    ...
    <div className="national-home">
      ...
      <section className="section-block" id="services">
        ...
        <div className="service-card-grid">
          <Link className="service-card service-traffic" to="/traffic"><div className="service-icon"><Navigation /></div><span className="service-live"><i /> Live</span><h3>Road & traffic</h3><p>Congestion, incidents, closures and smarter routes.</p><div><strong>{current.traffic}</strong><span>{location} traffic now</span></div><ArrowRight className="service-arrow" /></Link>
          ...
          <Link className="service-card service-river" to="/telemetry"><div className="service-icon"><Waves /></div><span className="service-live"><i /> Live</span><h3>Rivers & flood risk</h3><p>Water levels, forecasts and flood-prone areas.</p><div><strong>3 stations</strong><span>above warning level</span></div><ArrowRight className="service-arrow" /></Link>
          <Link className="service-card service-transport" to="/routing"><div className="service-icon"><TrainFront /></div><span className="service-live"><i /> Live</span><h3>Public transport</h3><p>Rail, metro, ferry and airport operations.</p><div><strong>92%</strong><span>services on time</span></div><ArrowRight className="service-arrow" /></Link>
          <Link className="service-card service-utility" to="/telemetry"><div className="service-icon"><Zap /></div><span className="service-live"><i /> Live</span><h3>Utilities</h3><p>Power, water and planned maintenance notices.</p><div><strong>8 notices</strong><span>scheduled today</span></div><ArrowRight className="service-arrow" /></Link>
          <Link className="service-card service-civic" to="/smart-hub"><div className="service-icon"><Landmark /></div><span className="service-badge">Directory</span><h3>Public services</h3><p>National helplines, offices and essential services.</p><div><strong>64 services</strong><span>in one directory</span></div><ArrowRight className="service-arrow" /></Link>
        </div>
      </section>
